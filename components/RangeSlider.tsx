...
export default function RangeSlider() {
  ...
  const name = "Price";
  const icon = "grip-lines";
  const minBoundary = 0;
  const maxBoundary = 5000000;
  const min_initVal = 500000;
  const max_initVal = 1200000;
  const colorNeutral = theme["color-primary-500"];
  const colorHighlight = theme["color-primary-500"];
  ...
  const min_getSlider = () => {
    return (
      ...
      >
        <View style={s.circle}>
          <View style={s.icon}>
            <FontAwesome5Icons name={icon} size={24} color={colorHighlight} />
          </View>
      ...
      <View style={s.container}>
        <View style={s.labelValue}>
          <Text style={s.labelValueText}>
            {getFormattedPrice(min_animState.displayVal, "en-US", "EGP")}
          </Text>
        </View>
        <View
          style={[
        ...
        <View style={s.labelValue}>
          <Text style={s.labelValueText}>
            {getFormattedPrice(max_animState.displayVal, "en-US", "EGP")}
          </Text>
        </View>
      </View>
    </View>
